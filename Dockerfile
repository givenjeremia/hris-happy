...
RUN apt update && apt install -y git unzip libpq-dev libpng-dev libjpeg-dev libwebp-dev libfreetype6-dev libxpm-dev libgd-dev zlib1g-dev libzip-dev libmagickwand-dev && docker-php-ext-install bcmath pdo pdo_pgsql gd zip #php-gd php-cli php-curl php-phar php-pgsql php-xml php-mbstring
...
RUN apt update && apt install -y git unzip libpq-dev && docker-php-ext-install bcmath  pdo pdo_pgsql && a2enmod rewrite headers #php-gd php-cli php-curl php-phar php-pgsql php-xml php-mbstring
