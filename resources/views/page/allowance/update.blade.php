            ...
            <div class="modal-body">
                <form id="FormUpdate">
                    ...
                    <div class="form-group required ">
                        ...
                        <input type="text" name="name" value="{{ $allowance->name }}" class="form-control" id="exampleInputEmail1" placeholder="Write Data">
                    </div>
                    <div class="form-group required ">
       ...
       $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = '{{ route("allowance.update", ":uuid") }}'.replace(':uuid','{{ $allowance->uuid }}')
