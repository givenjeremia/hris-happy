            ...
            <div class="modal-body">
                <form id="FormCreate">
                    ...
                    <div class="form-group required ">
                        ...
                        <input type="text" name="name" value="{{ $departement->name }}" class="form-control" id="exampleInputEmail1" placeholder="Write Data">
                    </div>
                </form>
            </div>
       ...
       $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = '{{ route("departements.update", ":uuid") }}'.replace(':uuid', '{{ $departement->uuid }}')
