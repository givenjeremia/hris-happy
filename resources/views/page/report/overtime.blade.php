...
@section('toolbar')
    @include('components.toolbar', ['title' => 'Overtime Report', 'subtitle' => 'Overtime Report'])
@endsection
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-3 align-self-end d-flex" style="gap: 10px;">
                <form method="GET" action="{{ route('reports.overtime.pdf') }}" target="_blank" class="w-50">
...
<script>
    $(document).ready(function() {
        var datatable = $('#example1').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('reports.overtime.table') }}",
                data: function (d) {
